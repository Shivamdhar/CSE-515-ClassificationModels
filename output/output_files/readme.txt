This directory contains all the output files for each task.
...
On line 16 replace "K" with the first alphabet of the heading. So if your heading is "Dominant images are -", replace "K" with "D".(in context with task4.html)
