...
class Task5b():
	...
	def index_images(self,image_feature_matrix):
		...
		lsh = Task5aLSH(L_layer_count,k_hash_size,image_feature_matrix,self.feature_count)
		...
		print(lsh.__getitem__(image_feature_matrix[images[0]]))
	...
	def runner(self):
		...
		self.index_images(image_feature_matrix)
